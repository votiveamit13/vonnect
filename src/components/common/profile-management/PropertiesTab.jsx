...
export default function PropertiesTab({ properties = [], loading }) {
  return (
    <div className="mt-4 px-4 sm:px-6 pb-10 space-y-5">
      ...
      {!loading && properties.length === 0 && (
        <div className="bg-white rounded-[16px] shadow-[0_10px_20px_-10px_rgba(0,0,0,0.25)] p-6 text-center">
        ...
        properties.map((unit, i) => (
          ...
          >
            ...
            <div className="px-5 pb-4 space-y-2">
              <Link
                href={`/owner/profile/${unit.id}/manage-unit`}
